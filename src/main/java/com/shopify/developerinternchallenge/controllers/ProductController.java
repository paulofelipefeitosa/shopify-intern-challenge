...
public class ProductController {
	...
	public @ResponseBody PublicProduct addShop(@PathVariable String shopName,
		...
		Shop shop = this.shopController.getShop(shopName);
		return this.shopService.addProduct2Shop(publicProduct, shop).getPublicProduct();
	}
	...
	public @ResponseBody PublicProduct editProductName(@PathVariable String shopName, @PathVariable String productId,
		...
		Shop shop = this.shopController.getShop(shopName);
		Product product = getProductById(productId, shop);
		return this.productService.editProductName(product, name).getPublicProduct();
	}
	...
	public @ResponseBody PublicProduct editProductDescription(@PathVariable String shopName,
		...
		Shop shop = this.shopController.getShop(shopName);
		Product product = getProductById(productId, shop);
		return this.productService.editProductDescription(product, description).getPublicProduct();
	}
	...
	public @ResponseBody PublicProduct editProductDescription(@PathVariable String shopName,
		...
		Shop shop = this.shopController.getShop(shopName);
		Product product = getProductById(productId, shop);
		return this.productService.editProductPrice(product, price).getPublicProduct();
	}
	...
	public @ResponseBody PublicProduct addProduct2Stock(@PathVariable String shopName, @PathVariable String productId,
		...
		Shop shop = this.shopController.getShop(shopName);
		Product product = getProductById(productId, shop);
		return this.productService.addProduct2Stock(product, add2Stock).getPublicProduct();
	}
